...
const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://chat.whatsapp.com/I5cpQYy9pqfJCPyw6rtb1e"}}}, { quoted: m})
        }
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
case 'msg': {
if (!args.join(" ")) return m.reply(`Example :\n${prefix + command} 91813xxxx|lol 😂😈`)
const cpace = args.join(" ")
const nony = cpace.split("|")[0];
if (nony.length <12) return m.reply('lol number sahi se dal☎️')
const massage = cpace.split("|")[1];
lol = `*| CHAT RUBA |*
Message from bot admin
Message : ${massage}`
XeonBotInc.sendMessage(nony + "@s.whatsapp.net", {text:lol}, {quoted:m})
}
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c16f0a17a2ca43baaaaf0.jpg' }, caption: `*Hi Bro ${m.pushName}*\n\nDonate Me : \n\n🐶 Fampay : https://telegra.ph/file/c16f0a17a2ca43baaaaf0.jpg\n🐶 Paytm : https://telegra.ph/file/c16f0a17a2ca43baaaaf0.jpg\n\nIf You Want To Donate, Talk With The Owner First\nwa.me/919797793240 (Click To Contact)` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`GitHub : https://github.com/chalipate/Rubabot.md\n Dont Forget To Give Star\n\nYouTube : ${myweb}\nDont Forget To Watch Tutorial`)
            }
            break
case 'allmenu': {
  	anu = `
...
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "YouTube📍","url": `${myweb}`}},{"urlButton": {"displayText": "Script🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
case 'thanksto': case 'thanks': case 'tq': case 'thank':
...
CYBÊR CALIPHÁTÊ (Me)
My family
And All Friends Who Helped Assemble This great Script !!!`,unicorn, [{"urlButton": {"displayText": "YouTube📍","url": `${myweb}`}},{"urlButton": {"displayText": "Script🔖","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
